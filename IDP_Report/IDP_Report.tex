...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Blockchain Voting with Agentic Accessibility}
\subCode{XX367P}
...
\guideNameA{Dr. N S Narahari}
\guideDesignationA{Visiting Professor}
\guideDeptA[IEM]{Industrial Engineering \& Management}
\guideOrgA{R V College of Engineering}
...
%% Pannel Members %%
\panelMemberNameA{S. G. Raghavendra Prasad}
\panelMemberDesigA{Assistant Professor}
\panelMemberDeptA[ISE]{Information Science and Engineering}
\panelMemberNameB{Dr. N. S. Narahari}
\panelMemberDesigB{Visiting Professor}
\panelMemberDeptB[IEM]{Industrial Engineering \& Management}

% Added Ver 3.6 & 3.9
%% Project co-ordinators (for Internal RVCE) 
\projectCoOrdNameA{Dr. Ravish Aradhya}
\projectCoOrdDesigA{HOD}
\projectCoOrdDeptA[IEM]{Industrial Engineering \& Management}

%%%%%%%%%%%%%%%%% Esteemed Members %%%%%%%%%%%%%%%%%%
\HOD{Rajeswara Rao K V S}
